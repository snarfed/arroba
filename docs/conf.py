# -*- coding: utf-8 -*-
#
# arroba documentation Sphinx build configuration file.
#
...
project = 'arroba'
copyright = '2023-2025, Ryan Barrett'
author = 'Ryan Barrett'
...
version = '2.0'
# The full 2ersion, including alpha/beta/rc tags.
release = '1.0'
...
exclude_patterns = ['_build', '**/tests', '**/test_*.py']
...
# of the sidebar.
html_logo = '_static/atproto_logo.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
# html_favicon = '_static/atproto_logo.png'
...
latex_documents = [
  (master_doc, 'arroba.tex', 'arroba Documentation',
   'Ryan Barrett', 'manual'),
]
...
man_pages = [
    (master_doc, 'arroba', 'arroba documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'arroba', 'arroba Documentation',
   author, 'arroba', 'One line description of project.',
   'Miscellaneous'),
]
...
intersphinx_mapping = {
    'ec': ('https://cryptography.io/en/stable', None),
